                    ...
                    <form>
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input id="email" type="email" name="email" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg w-full py-2 focus:outline-none" placeholder="Name" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input id="email" type="email" name="email" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg w-full py-2 focus:outline-none" placeholder="E-Mail Address" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input id="password" type="password" name="password" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg w-full py-2 focus:outline-none" placeholder="Password" />
                            </div>
                        </div>
